Для запуска в командной строке (запуск от имени администратора) в папку MFKSReposrtService\bin\Debug:
CMD: MFKSReposrtService.exe --install - для установки
CMD: MFKSReposrtService.exe --uninstall - для удаления
...
Select [dbo].[udf-Str-JSON](0,1,(SELECT TOP (10) BusinessEntityID, FirstName, MiddleName, LastName
